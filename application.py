...
def index():
    if request.method == 'POST':
       ...
       features = np.array([[lead_time, no_of_special_requests, avg_price_per_room, arrival_month, arrival_date, market_segment, no_of_week_nights, no_of_weekend_nights, meal_plan, room_type]])
